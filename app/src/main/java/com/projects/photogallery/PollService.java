...
/**
 * Created by clarignon on 5/25/15.
 */
public class PollService extends IntentService {
    ...
    public static final String ACTION_SHOW_NOTIFICATION =
            "com.projects.photogallery.SHOW_NOTIFICATION";

    public static final String PERM_PRIVATE = "com.projects.photogallery.PRIVATE";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (!isNetworkingAvailable) {
            Log.i(TAG, "No networking available");
            return;
        }
